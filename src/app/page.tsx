            ...
            <div className="text-center mb-8 flex flex-col items-center">
              <div className="w-16 h-16 bg-[var(--verde-bg)] border border-[var(--verde-border)] rounded-2xl flex items-center justify-center text-[var(--verde)] shadow-md mb-4 p-2.5">
                <svg className="w-full h-full" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M 256 80 L 416 160 L 256 240 L 96 160 Z" fill="url(#grad-emerald-login)" />
                  ...
                  <path d="M 160 220 L 160 360 C 160 400, 220 420, 256 420" stroke="url(#grad-blue-login)" strokeWidth="32" strokeLinecap="round" />
                  <path d="M 352 220 L 352 360 C 352 400, 292 420, 256 420" stroke="url(#grad-emerald-login)" strokeWidth="32" strokeLinecap="round" />
                  ...
                  <defs>
                    <linearGradient id="grad-emerald-login" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#10B981" />
                      <stop offset="100%" stopColor="#059669" />
                    </linearGradient>
                    <linearGradient id="grad-blue-login" x1="0%" y1="0%" x2="100%" y2="100%">
