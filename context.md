...
| **Directivo** | Puede asignar roles de **Preceptor**, **Profesor** y **Alumno**. Gestiona cursos, profesores y la asignación bidireccional de cursos a preceptores en `PreceptoresTab` (desde tarjetas de preceptores o haciendo clic directo en cualquier división escolar) y supervisa preceptorías en `CursosTab`. Envía avisos generales institucionales y por curso. | No puede degradar ni cambiar el rol de Administradores. |
...
| **Profesor** | Carga asistencias (jornada y materia), solicita sus ausencias, visualiza sus horarios y mesas de examen asignadas. | • **No puede ver el padrón de otros profesores** (la pestaña 'Profesores' está bloqueada; no ve DNI, teléfono ni email de colegas).<br>• En 'Ausencias', **solo ve su propio historial y licencias** (no ve las de otros docentes).<br>• No puede cambiar roles ni alterar horarios. |
| **Alumno** | Consulta sus horarios de cursada, ausencias docentes del día, mesas de examen y genera su credencial QR personal para acreditación de asistencia. | • **No puede ver datos de otros alumnos** (ni nombre, ni DNI, ni email, ni teléfono). La app nunca descarga el padrón completo a su navegador.<br>• En Mesas de Examen solo ve la confirmación de su propio examen.<br>• No puede editar información institucional ni cambiar roles. |
